...
class InsertLink: MarkupDelegate {
    ...
    /// any way around it.
    func setActions() {
        Self.tests[0].action = { self.webView.insertLink(Self.tests[0].pasteString!) }
        Self.tests[1].action = { self.webView.insertLink(Self.tests[1].pasteString!) }
        Self.tests[2].action = { self.webView.insertLink(Self.tests[2].pasteString!) }
        Self.tests[3].action = { self.webView.insertLink(Self.tests[3].pasteString!) }
        Self.tests[4].action = { self.webView.insertLink(Self.tests[4].pasteString!) }
    }
